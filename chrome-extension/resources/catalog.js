(function () {
  ...
  const WEAPONS = [
    ...
    "M4A1-S", "M4A4", "MAC-10", "MAG-7", "MP5-SD", "MP7", "MP9",
    "Negev", "Nova", "P2000", "P250", "P90", "PP-Bizon", "R8 Revolver",
    "Sawed-Off", "SCAR-20", "SG 553", "SSG 08", "Tec-9", "UMP-45",
    "USP-S", "XM1014"
  ];
  ...
  globalThis.SkinWatcherCatalog = Object.freeze({
    ITEM_TYPES: ["Weapon", "Knife", "Gloves"],
    ITEMS_BY_TYPE: Object.freeze({ Weapon: WEAPONS, Knife: KNIVES, Gloves: GLOVES }),
    WEAPONS,
    KNIVES,
    GLOVES
  });
